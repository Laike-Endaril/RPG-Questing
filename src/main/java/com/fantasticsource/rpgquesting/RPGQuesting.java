...
@Mod(modid = RPGQuesting.MODID, name = RPGQuesting.NAME, version = RPGQuesting.VERSION, dependencies = "required-after:fantasticlib@[1.12.2.026b,)", acceptableRemoteVersions = "[1.12.2.000j,1.12.2.000k]")
